  ...
  <div class="mb-5"></div>
    ...
    <div id="carouselExampleControls" class=" carousel slide d-flex flex-column flex-shrink-0 p-3 bg-body-tertiary border border-2" data-bs-ride="carousel">
  ...
  <!-- akhir carausal -->
      ...
      <div class="bg-black opacity-50 text-white">
            <h1 class="display-4">Sejarah Kelurahan</h1>
            <p class="lead">Sejarah Kelurahan Malasilen</p>
            <hr class="my-4">
            <p>kelurahan</p>
            <div class="m-2">
              <a href="sejarah.php"><button class="btn btn-primary btn-lg" type="button">Sejarah</button></a>
            </div>
          </div>
          </div>
        </div>
  ...
  <div class="bg-black opacity-50 text-white">
            ...
            <p>kelurahan</p>
            <div class="m-2">
              <a href="rt.php"><button class="btn btn-primary btn-lg" type="button">RT/RW</button></a>
            </div>
            </div>
          </div>
        </div>
  ...
  <!-- awal carausel -->
        <div class="carousel-item ">
          <div class="p-5 text-center bg-body-tertiary rounded-3" style="height: 400px ;background-image: url('../assets/Malasilen.jpeg'); background-position: center; background-size: cover;">
  <div class="bg-black opacity-50 text-white">
            <h1 class="display-4">Peranggkat Kelurahan</h1>
            <p class="lead"></p>
            <hr class="my-4">
            <p>kelurahan</p>
            <div class="m-2">
              <a href="Plurah.php"><button class="btn btn-primary btn-lg" type="button">Peranggkat Kelurahan</button></a>
            </div>
          </div>
          </div>
        </div>
  ...
  <div class="bg-black opacity-50 text-white">
            ...
            <p>kelurahan</p>
            <div class="m-2">
              <a href="galeri.php"><button class="btn btn-primary btn-lg" type="button">Galeri</button></a>
            </div>
            </div>
          </div>
        </div>
