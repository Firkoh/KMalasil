...
<!-- pemisah -->
<div class="container-fluid mt-4"> <!-- Menambah margin top -->
  <div class="row">
    ...
    <!-- konten utama sejarah, visi, dan misi -->
    <div class="col-md-9 col-12 border border-2 mt-3"> <!-- Menambah margin top -->
      <div class="row">
        <div class="col-md-12 col-12 p-4 border border-2"> <!-- Menambah padding -->
          <?php
          ...
          <p><?php echo $MISI; ?></p>
          <p class="text-end"><i>Tanggal Update: <?php echo $TGL; ?></i></p>
        </div>
      </div>
    </div>
